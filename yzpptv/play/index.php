...
<link rel="stylesheet" type="text/css" href="../static_pp/css/play.css">
</head>

<body class="body">

<div class="header one">
	<a class="logo" href="../" style="background-image:url(../static_pp/images/logo.png)"></a>
	<div class="search">
...
<div class="list" style="margin-top:1rem">
	...
	<h3 class="title"><span>猜你喜欢</span></h3>
...
<script src="../static_pp/js/play.js"></script>
</body>
</html>