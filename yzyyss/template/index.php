...
<body>
    ...
    <section class="am-g about">
        <div class="am-container am-margin-vertical-xl">
            <header class="am-padding-vertical">
                ...
                <p class="am-text-center">多站合一音乐搜索</p>
            </header>
            <hr>
    ...
    <footer class="footer">
        <p class="am-text-sm">v<?php echo MC_VERSION; ?>&nbsp;&copy;&nbsp;<?php echo date('Y'); ?>&nbsp;<a href="http://dd.vxcc.top" target="_blank" rel="author">汇看视界</a>&nbsp;<a href="http://dd.vxcc.top" target="_blank">汇看视界</a>&nbsp;<a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}">汇看视界</a></p>
    </footer>
