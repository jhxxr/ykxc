...
function filter($keyword)
{
    ...
    if (is_numeric($keyword)) {
        echo echores($res = "你搞事情.兔兔提醒你:多注意身体:少搞h", $code = 500);
        exit;
    }
    $blacklist = "韩国|福利片|丝袜|强奸|车展|美女|范拍|真人秀|小姐|写真|自拍|美女|趣向|内衣|欧美|日韩|街拍";
    ...
    if (preg_match("/$blacklist/", $keyword)) {
        echo echores($res = "你搞事情.兔兔提醒你:多注意身:少搞h", $code = 500);
        exit;
    } else {
        return $keyword;
    }
